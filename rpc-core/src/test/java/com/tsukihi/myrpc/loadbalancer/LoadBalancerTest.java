...
//        requestParams.put("methodName", "apple");
        ...
        List<ServiceLoadInfo> servers = new ArrayList<>();
        ...
        servers.add(new ServiceLoadInfo(serviceMetaInfo1));
        ...
        servers.add(new ServiceLoadInfo(serviceMetaInfo2));
        ...
        servers.add(new ServiceLoadInfo(serviceMetaInfo3));
        ...
        servers.add(new ServiceLoadInfo(serviceMetaInfo4));
        ...
        servers.add(new ServiceLoadInfo(serviceMetaInfo5));
